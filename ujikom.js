const questions = [
  {
      ...
      options: ['Random Access Memory', 'Run Access Memory', 'Random Access Manage', 'Remote Access Memory'],
      answer: "Random Access Memory"
  },
  {
      question: "Di bawah ini yang termasuk media penyimpanan, kecuali:",
      options: ['Flashdisk', 'Harddisk', 'Mouse', 'Disket'],
      answer: "Mouse"
  },
  {
      question: "Di mana tempat masukan konektor keyboard dan mouse pada port motherboard?",
      options: ['Port AT/PS2', 'Port paralel', 'Port LAN', 'Port serial'],
      answer: "Port AT/PS2"
  },
  {
      question: "Papan rangkaian komputer tempat semua komponen elektronik komputer terangkai disebut dengan:",
      options: ['Keyboard', 'Motherboard', 'Casing', 'Peripheral'],
      answer: "Motherboard"
  },
  {
      question: "Slot AGP pada motherboard merupakan singkatan dari:",
      options: ['Accurated Graphics Por', 'Accelerated Grade Portable', 'Accelerated Graphics Port', 'Accumulation Grade Port'],
      answer: "Accelerated Graphics Port"
  },
  {
      question: "Slot PCI (Peripheral Component Interconnect) di motherboard dapat dipasang berbagai kartu ekspansi, salah satunya yaitu:",
      options: ['Kartu VGA', 'Kartu memory', 'Kartu telepon', 'Kartu modem'],
      answer: "Kartu VGA"
  },
  {
      question: "Pada motherboard terdapat memory permanen sebagai penyimpanan data dari komponen komputer disebut:",
      options: ['RAM', 'ROM', 'BIOS', 'CMOS'],
      answer: "ROM"
  },
  {
      question: "Pada motherboard, peralatan seperti camera digital, scanner, dan handycam disambungkan ke port:",
      options: ['Port serial', 'Port USB', 'Port paralel', 'Port audio'],
      answer: "Port USB"
  },
  {
      question: "Port audio dalam motherboard dihubungkan dengan berbagai macam peralatan, antara lain:",
      options: ['Kartu, radio, speaker', 'Keyboard, mouse, printer', 'Tape, kartu, speaker', 'Radio, speaker, mikrofon'],
      answer: "Radio, speaker, mikrofon"
  },
  {
      question: "Berikut ini yang bukan merupakan langkah instalasi pada Windows status adalah:",
      options: ['Copying Windows Files', 'Getting Files ready for installation', 'Installing Firewall', 'Installing Updates'],
      answer: "Installing Firewall"
  },
  {
      question: "Nama lain dari motherboard adalah:",
      options: ['Clipboard', 'Multiboard', 'Mainboard', 'Mothboard'],
      answer: "Mainboard"
  },
  {
      question: "Pada instalasi Windows kita harus memilih perintah apa agar Windows terinstall ulang?",
      options: ['Repair', 'Custom (Advanced)', 'Upgrade', 'Safe mode'],
      answer: "Custom (Advanced)"
  },
  {
      question: "Berikut ini yang tidak termasuk sistem operasi adalah:",
      options: ['DOS', 'Linux', 'Cobol', 'Unix'],
      answer: "Cobol"
  },
  {
      question: "Kenapa kita harus memasukkan Lisensi Key pada Windows?",
      options: ['Untuk mengakses semua fitur Windows secara legal', 'Agar Windows bisa berjalan lebih cepat', 'Supaya bisa menghapus virus secara otomatis', 'Agar Windows tidak perlu diperbarui'],
      answer: "Untuk mengakses semua fitur Windows secara legal"
  },
  {
      question: "Jenis Keyboard mana saja yang biasanya umum digunakan oleh negara lokal?",
      options: ['QWERTY, AZERTY, DVORAK', 'QWERTY, JIS, ANSI', 'DVORAK, COLEMAK, WORKMAN', 'QWERTY, AZERTY, QWERTZ'],
      answer: "QWERTY, AZERTY, QWERTZ"
  },
  {
      question: "Putih Oranye - Oranye - Putih Hijau - Biru - Putih Biru - Hijau - Putih Coklat - Coklat. Merupakan urutan kabel straight.",
      options: ['Benar', 'Salah'],
      answer: "Benar"
  },
  {
      question: "Untuk menguji keberhasilan instalasi software aplikasi dengan cara:",
      options: ['Dijalankan tanpa ada masalah', 'Terdapat dalam start all program', 'Bisa dibuat shortcut', 'Muncul dalam icon taskbar'],
      answer: "Dijalankan tanpa ada masalah"
  }
];
